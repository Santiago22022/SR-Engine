...
<h1 align="center">
  <br>
  <a href="https://github.com/JordanSantiagoYT/FNF-SR-Engine"><img src="/art/iconOG.png" alt="SRengine" width="150"></a>
  <br>
  <b>SR Engine</b>
  <br>
  <i>(Santiago/SR Engine)</i>
  <br>
</h1>
<h3 align="center">
  <b>SR Engine is a heavily modified Psych Engine fork, with lower-end devices and more customization in mind.</b>
</h3>
...
Welcome to SR Engine's github repo, where you can download the engine and make spammy charts or have fun with the engine.

This contains lots and lots of customizable and features built in to SR Engine, if you wanna see most of them listed, you can see it below this text

# Features/Performances in SR ENGINE
...
There is like lots and lots of stuff i've missed, but at least you would like those features built in **SR ENGINE**
...
inside `Project.xml`, you will find several variables to customize SR Engine to your liking
...
@PatoFlamejanteTV
- Small coding, also made a PDF guide for SR Engine.

### The rest of the lovely contributors on GitHub! (Psych and SR Engine)
