Songs are rendered here! If you delete this folder there's a 99.99% chance that Rendering Mode won't work, even if you put FFmpeg.exe in the same folder as SREngine.exe. 
