...
class ClientPrefs { //default settings if it can't find a save file containing your current settings
	...
	public static var opponentStrums:Bool = #if html5 false #else true #end;
	public static var ghostTapping:Bool = #if html5 false #else true #end;
	public static var autoPause:Bool = #if html5 false #else true #end;
	...
	public static var spaceVPose:Bool = #if html5 false #else true #end;
	public static var ghostTapAnim:Bool = #if html5 false #else true #end;
	public static var hitsoundVolume:Float = #if html5 0 #else 0.5 #end;
	...
	public static var noteSplashes:Bool = #if html5 false #else true #end;
	public static var oppNoteSplashes:Bool = #if html5 false #else true #end;
	public static var showNPS:Bool = #if html5 false #else true #end;
	public static var showComboInfo:Bool = #if html5 false #else true #end;
	public static var maxSplashLimit:Int = #if html5 8 #else 16 #end;
	public static var oppNoteAlpha:Float = 0.65;
	public static var hideHud:Bool = false;
	public static var tauntOnGo:Bool = #if html5 false #else true #end;
	...
	public static var botWatermark:Bool = #if html5 false #else true #end;
	public static var missRating:Bool = false;
	public static var noteColorStyle:String = 'Normal';
	public static var enableColorShader:Bool = #if html5 false #else true #end;
	...
	public static var strumLitStyle:String = #if html5 'Static' #else 'Full Anim' #end;
	public static var bfIconStyle:String = 'Default';
	public static var ratingType:String = 'Default';
	public static var simplePopups:Bool = #if html5 true #else false #end;
	public static var iconBounceType:String = 'New Psych';
	public static var smoothHealth:Bool = #if html5 false #else true #end;
	public static var smoothHPBug:Bool = false;
	public static var ogHPColor:Bool = false;
	public static var flashing:Bool = #if html5 false #else true #end;
	public static var camZooms:Bool = #if html5 false #else true #end;
	public static var showNotes:Bool = #if html5 true #else true #end;
	public static var scoreZoom:Bool = #if html5 false #else true #end;
	public static var healthBarAlpha:Float = 1;
	public static var showFPS:Bool = #if html5 false #else true #end;
	public static var randomBotplayText:Bool = #if html5 false #else true #end;
	public static var botTxtFade:Bool = #if html5 false #else true #end;
	public static var pauseMusic:String = 'Tea Time';
	public static var daMenuMusic:String = 'Default';
	public static var checkForUpdates:Bool = #if html5 false #else true #end;
	public static var comboStacking = #if html5 false #else true #end;
	public static var showRamUsage:Bool = #if html5 false #else true #end;
	public static var showMaxRamUsage:Bool = #if html5 false #else true #end;
	public static var debugInfo:Bool = #if html5 false #else true #end;
	public static var tipTexts:Bool = #if html5 false #else true #end;
	public static var discordRPC:Bool = #if html5 false #else true #end;
	public static var peOGCrash:Bool = false;

	//Graphics
	public static var lowQuality:Bool = #if html5 true #else false #end;
	public static var globalAntialiasing:Bool = #if html5 false #else true #end;
	public static var shaders:Bool = #if html5 false #else true #end;
	public static var cacheOnGPU:Bool = #if html5 false #else false #end;
	public static var dynamicSpawnTime:Bool = #if html5 true #else false #end;
	public static var noteSpawnTime:Float = #if html5 1.2 #else 1 #end;
	public static var resolution:String = #if html5 '800x600' #else '1280x720' #end;
	public static var framerate:Int = #if html5 30 #else 60 #end;

	//Optimization
	public static var charsAndBG:Bool = #if html5 false #else true #end;
	public static var enableGC:Bool = #if html5 true #else true #end;
	public static var opponentLightStrum:Bool = #if html5 false #else true #end;
	public static var botLightStrum:Bool = #if html5 false #else true #end;
	public static var playerLightStrum:Bool = #if html5 false #else true #end;
	public static var ratingPopups:Bool = #if html5 false #else true #end;
	public static var comboPopups:Bool = #if html5 false #else true #end;
	public static var showMS:Bool = #if html5 false #else false #end;
	public static var noSpawnFunc:Bool = #if html5 false #else false #end;
	public static var noHitFuncs:Bool = #if html5 true #else false #end;
	public static var noSkipFuncs:Bool = #if html5 true #else false #end;
	public static var lessBotLag:Bool = #if html5 true #else false #end;
	public static var maxNotes:Int = #if html5 800 #else 0 #end;
