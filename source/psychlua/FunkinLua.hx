...
class FunkinLua {
	...
	public static var lastCalledFunction:String = '';
	...
	public function addLocalCallback(name:String, myFunction:Dynamic):Void {
		...
		customFunctions.set(name, myFunction);
	}

	public function call(func:String, args:Array<Dynamic> = null, ignoreStops:Bool = false):Dynamic {
