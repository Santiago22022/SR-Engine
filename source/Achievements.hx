...
class Achievements {
	...
	{
		createAchievement('friday_night_play',		{name: "SYBAU", description: "Play on a Friday... Night.", hidden: true});
		...
		createAchievement('ur_bad',					{name: "Fuck you bitch", description: "Complete a Song with a rating lower than 20%."});
